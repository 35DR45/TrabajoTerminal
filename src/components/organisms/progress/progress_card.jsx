    ...
    return(
        <div className="Progress_Container">
            <div className="progress_section">
                ...
                <Gauge width={100} height={100} value={Number(teo).toFixed(2)} startAngle={-90} endAngle={90} />
            </div>
            <div className="progress_section">
                <p className="progress_text" id="Practica">Lecciones prácticas: </p>
                <Gauge width={100} height={100} value={Number(pra).toFixed(2)} startAngle={-90} endAngle={90} />
            </div>
            <div className="progress_section">
                <p className="progress_text" id="Total">Progreso total: </p>
                <Gauge width={100} height={100} value={Number(tot).toFixed(2)}/>
            </div>
        </div>
    )
}